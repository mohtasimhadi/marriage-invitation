...
export default function Wedding() {
  ...
  const bnDateStr = targetDate.toLocaleString("bn-BD", {
    dateStyle: "full",
  });
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="text-left">
                ...
                <div className="mt-2 text-white/90">
                  আন্তর্জাতিক কনভেনশন সিটি বসুন্ধরা
                </div>
                <div className="mt-1 text-white/90">হল- ০২, পুষ্পগুচ্ছ</div>
                <div className="mt-1 text-white/80">পূর্বাচল এক্সপ্রেসওয়ে, ঢাকা</div>
              </div>
              <div className="shrink-0">
                <AButton
                  href="https://maps.app.goo.gl/4z6JEoG1DZAip9XS7"
  ...
  <div className="w-full aspect-[16/9] rounded-2xl overflow-hidden ring-1 ring-white/25">
    <iframe
      ...
      src={
        ...
        encodeURIComponent("International Convention City Bashundhara Hall 2, Dhaka") +
        "&output=embed"
      }
      allowFullScreen
    />
