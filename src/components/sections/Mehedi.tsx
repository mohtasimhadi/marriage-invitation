...
export default function Mehedi() {
  const targetDate = useMemo(() => new Date("2025-12-23T17:30:00+06:00"), []);
  ...
  const venueName = "আজিজ মঞ্জিল";
  const venueAddr = "৩/৫ তোপখানা রোড, ঢাকা";
